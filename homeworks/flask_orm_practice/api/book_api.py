...
def book_get():
    ...
    books = Book.query.order_by(Book.name_book)
...
def book_create():
    ...
    try:
        ...
        new_book = Book(name_book=book_data['name_book'], author_book=book_data['author_book'])
...
def book_update(id_):
    ...
    try:
        ...
        upd_book.name_book = book_data['name_book']
        upd_book.author_book = book_data['author_book']
        db.session.commit()
